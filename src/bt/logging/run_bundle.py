...
def hermes_run_payload(receipt: dict[str, Any], lineage: dict[str, Any]) -> dict[str, Any]:
    ...
    run = {
        ...
        "market_model_bundle_digest": str(lineage["market_model_bundle_digest"]),
        "representation_contract_digest": str(lineage["representation_contract_digest"]),
        "search_plan_digest": str(lineage["search_plan_digest"]),
