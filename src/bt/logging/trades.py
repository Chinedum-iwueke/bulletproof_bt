...
class TradesCsvWriter:
    ...
    def write_trade(self, trade: Trade) -> None:
        ...
        computed_values: dict[str, Any] = {
            ...
            "signal_ts": metadata.get("signal_ts"),
            "pnl_price": pnl_price,
            "fees_paid": fees_paid,
            "pnl_net": pnl_net,
            "risk_amount": risk_amount,
            "requested_risk_amount": metadata.get("requested_risk_amount"),
            "risk_utilization_pct": metadata.get("risk_utilization_pct"),
            "under_risked_trade": metadata.get("under_risked_trade"),
